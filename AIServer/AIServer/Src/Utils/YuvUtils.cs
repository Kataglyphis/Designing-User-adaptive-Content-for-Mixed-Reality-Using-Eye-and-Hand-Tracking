...
/*
    This file is from the MixedReality WebRTC UWP example app
    src: https://github.com/microsoft/MixedReality-WebRTC/tree/master/examples/TestAppUwp
 */
...
namespace AIServer.Video
{
    public static class YuvUtils
    {
        ...
        public static void CopyYuvToBufferAsRgb(IntPtr dataY, IntPtr dataU, IntPtr dataV,
